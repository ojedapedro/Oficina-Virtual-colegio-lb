...
import { BarChart3, Filter, PieChart, Download } from 'lucide-react';
      ...
      <div className="p-6">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Note: Level filtering depends on backend support which might be limited with current sheet structure */}
            <div>
